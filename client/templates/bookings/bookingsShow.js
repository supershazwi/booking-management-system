...
Template.bookingsShow.helpers({
  ...
  needUpdate: function() {
    return (InvoiceNeedingUpdate.findOne({bookingId: Router.current().params._id}) != undefined || BookingUpdates.findOne({invoiceId: Router.current().params._id}).status != "OK");
  },
  bookingId: function() {
